  ...
  <div class="brand-list">
    ...
    >
      <div class="operation-row">
        <div class="left-operations">
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.GOODS.BRAND.CREATE)"
            type="primary" 
            @click="handleAdd"
          >
          ...
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.GOODS.BRAND.DELETE)"
            type="danger" 
    ...
    >
      ...
      >
        ...
        />
        <el-table-column 
          v-if="hasActionPermission(PERMISSIONS.GOODS.BRAND.EDIT) || hasActionPermission(PERMISSIONS.GOODS.BRAND.DELETE)"
          label="操作" 
          width="180" 
          fixed="right"
        >
          <template #default="{ row }">
            <div class="action-buttons">
              <el-button 
                v-if="hasActionPermission(PERMISSIONS.GOODS.BRAND.EDIT)"
                type="primary" 
                size="small"
