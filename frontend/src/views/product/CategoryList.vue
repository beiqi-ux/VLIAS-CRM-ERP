    ...
    >
      <div class="operation-row">
        <div class="left-operations">
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.GOODS.CATEGORY.CREATE)"
            type="primary" 
            @click="handleAdd"
          >
        ...
        >
          <template #default="{ row }">
            <div class="action-buttons">
              ...
              <el-button 
                v-if="hasActionPermission(PERMISSIONS.GOODS.CATEGORY.EDIT)"
                type="primary" 
                size="small"
              ...
              <el-button 
                v-if="hasActionPermission(PERMISSIONS.GOODS.CATEGORY.DELETE)"
                type="danger" 
                size="small"
