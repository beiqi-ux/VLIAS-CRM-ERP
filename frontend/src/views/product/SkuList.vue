  ...
  <div class="sku-list">
    ...
    >
      ...
      >
        ...
        <el-form-item>
          <el-button
            v-if="hasActionPermission(PERMISSIONS.GOODS.SKU.VIEW)"
            type="primary"
            :loading="loading"
            @click="handleSearch"
          >
    ...
    >
      <div class="operation-row">
        <div class="left-operations">
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.GOODS.SKU.CREATE)"
            type="primary" 
            @click="handleAdd"
          >
          ...
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.GOODS.SKU.DELETE)"
            type="danger" 
    ...
    >
      ...
      >
        ...
        >
          <template #default="{ row }">
            <el-button
              v-if="hasActionPermission(PERMISSIONS.GOODS.SKU.EDIT)"
              type="primary"
              size="small"
