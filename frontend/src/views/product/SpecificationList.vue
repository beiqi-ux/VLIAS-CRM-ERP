<template>
  <div class="specification-management">
    ...
    <el-tabs v-model="activeTab" type="border-card">
      <!-- 规格分类管理 -->
      <el-tab-pane label="规格分类管理" name="categories">
    ...
    <!-- 搜索栏 -->
        ...
        <el-form-item>
                <el-button type="primary" :loading="categoryLoading" @click="handleCategorySearch">
    ...
    <!-- 操作栏 -->
      ...
      <div class="operation-row">
        ...
        <div class="right-operations">
                <el-button type="success" @click="handleRefreshCategories">
            <el-icon><Refresh /></el-icon>
            刷新
          </el-button>
        </div>
    ...
    <!-- 数据表格 -->
      ...
      <!-- 规格项管理 -->
      <el-tab-pane label="规格项管理" name="items">
        <div class="specification-items">
          ...
          <el-select
            ...
            clearable
              ...
              <el-form-item>
                <el-button type="primary" :loading="itemLoading" @click="handleItemSearch">
                  <el-icon><Search /></el-icon>
                  搜索
                </el-button>
          ...
          <el-card class="table-card" shadow="never">
            ...
            >
              <el-table-column type="selection" width="55" />
              <el-table-column prop="itemCode" label="规格项代码" width="120" />
              <el-table-column prop="itemName" label="规格项名称" width="150" />
              ...
              <el-table-column prop="isSku" label="影响SKU" width="100">
                <template #default="{ row }">
      ...
      <!-- 规格值管理 -->
      <el-tab-pane label="规格值管理" name="values">
        <div class="specification-values">
          <!-- 搜索栏 -->
          <el-card class="search-card" shadow="never">
                        <el-form :model="valueSearchForm" inline>
              ...
              <el-form-item>
                <el-button type="primary" :loading="valueLoading" @click="handleValueSearch">
                  <el-icon><Search /></el-icon>
                  搜索
                </el-button>
          ...
          <el-card class="table-card" shadow="never">
            ...
            >
              <el-table-column type="selection" width="55" />
              <el-table-column prop="valueCode" label="规格值代码" width="120" />
              <el-table-column prop="valueName" label="规格值名称" width="150" />
              <el-table-column prop="categoryId" label="所属分类" width="120">
                <template #default="{ row }">
                  {{ getCategoryNameByItemId(row.itemId) }}
                </template>
              </el-table-column>
              <el-table-column prop="itemId" label="所属规格项" width="150">
                <template #default="{ row }">
                  {{ getItemName(row.itemId) }}
                </template>
              </el-table-column>
              <el-table-column prop="textValue" label="文本值" width="120" />
              <el-table-column prop="numericValue" label="数值" width="100" />
              <el-table-column prop="status" label="状态" width="80">
                <template #default="{ row }">
                  <el-tag :type="row.status === 1 ? 'success' : 'danger'">
                    {{ row.status === 1 ? '启用' : '禁用' }}
              ...
              <el-table-column prop="sortOrder" label="排序" width="80" />
              <el-table-column prop="valueDesc" label="描述" min-width="150" show-overflow-tooltip />
              <el-table-column prop="createTime" label="创建时间" width="160">
                <template #default="{ row }">
                  {{ formatDateTime(row.createTime) }}
                </template>
              ...
              <el-table-column label="操作" width="180" fixed="right">
                <template #default="{ row }">
                  <el-button type="primary" size="small" @click="handleEditValue(row)">
                    <el-icon><Edit /></el-icon>
                    编辑
                  </el-button>
                  <el-button type="danger" size="small" @click="handleDeleteValue(row)">
                    <el-icon><Delete /></el-icon>
                    删除
                  </el-button>
                </template>
    ...
    >
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="规格分类" prop="categoryId">
                  <el-select
        ...
        <el-form-item label="规格项代码" prop="itemCode">
          <el-input
            v-model="itemForm.itemCode"
            placeholder="请输入规格项代码"
          />
        </el-form-item>
        <el-form-item label="规格项名称" prop="itemName">
                  <el-input
    ...
    >
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="规格项" prop="itemId">
                  <el-select
        ...
        <el-form-item label="规格值代码" prop="valueCode">
          <el-input
        ...
        <el-form-item label="描述" prop="valueDesc">
                  <el-input
