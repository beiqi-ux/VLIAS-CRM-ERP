    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>部门管理</span>
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.ORGANIZATION.DEPARTMENT.CREATE)"
            type="primary" 
            @click="handleAdd"
          >
            新增部门
      ...
      >
        ...
        <el-table-column 
          v-if="hasActionPermission(PERMISSIONS.ORGANIZATION.DEPARTMENT.EDIT) || hasActionPermission(PERMISSIONS.ORGANIZATION.DEPARTMENT.DELETE)"
          label="操作" 
          width="200" 
          fixed="right"
        >
          <template #default="{ row }">
            <el-button 
              v-if="hasActionPermission(PERMISSIONS.ORGANIZATION.DEPARTMENT.EDIT)"
              type="primary" 
              size="small" 
            ...
            <el-button 
              v-if="hasActionPermission(PERMISSIONS.ORGANIZATION.DEPARTMENT.DELETE)"
              type="danger" 
              size="small" 
      ...
      >
        ...
        >
          <el-input
            ...
            placeholder="请输入部门编码"
            :rules="[{ validator: validateDeptCode, trigger: 'blur' }]"
          />
        </el-form-item>
