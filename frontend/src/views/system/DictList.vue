<template>
  <div class="dict-container">
    <div class="search-bar">
      ...
      <el-button 
        v-if="hasActionPermission(PERMISSIONS.SYS.DICT.CREATE)"
        type="success" 
    ...
    >
      ...
      <el-table-column 
        v-if="hasActionPermission(PERMISSIONS.SYS.DICT.EDIT) || hasActionPermission(PERMISSIONS.SYS.DICT.DELETE)"
        label="操作" 
        width="280" 
        fixed="right"
      >
        <template #default="scope">
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.SYS.DICT.EDIT)"
            size="small" 
          ...
          <el-button
            v-if="hasActionPermission(PERMISSIONS.SYS.DICT.DELETE)"
            size="small"
            type="danger"
