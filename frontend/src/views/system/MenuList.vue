    ...
    <TableContainer>
      <template #actions>
        <div class="action-bar">
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.SYS.MENU.CREATE)"
            type="primary" 
          ...
          <el-button
            v-if="hasActionPermission(PERMISSIONS.SYS.MENU.EDIT)"
            type="warning"
      ...
      >
        ...
        <el-table-column 
          v-if="hasActionPermission(PERMISSIONS.SYS.MENU.EDIT) || hasActionPermission(PERMISSIONS.SYS.MENU.CREATE) || hasActionPermission(PERMISSIONS.SYS.MENU.DELETE)"
          label="操作" 
          width="320" 
          fixed="right"
        >
          <template #default="scope">
            <div class="operation-buttons">
              ...
              <el-button 
                v-if="scope.row.menuType !== 3 && hasActionPermission(PERMISSIONS.SYS.MENU.CREATE)" 
                size="small" 
                type="success" 
              ...
              <el-button 
                v-if="hasActionPermission(PERMISSIONS.SYS.MENU.DELETE)"
                size="small" 
                type="danger" 
