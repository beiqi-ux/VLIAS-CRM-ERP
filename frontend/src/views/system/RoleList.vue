<template>
  <div class="role-container">
    <div class="search-bar">
      ...
      <el-button 
        v-if="hasActionPermission(PERMISSIONS.SYS.ROLE.CREATE)"
        type="success" 
    ...
    >
      ...
      <el-table-column 
        v-if="hasActionPermission(PERMISSIONS.SYS.ROLE.EDIT) || hasActionPermission(PERMISSIONS.SYS.ROLE.DELETE) || hasActionPermission(PERMISSIONS.SYS.ROLE.ASSIGN_PERMISSION)"
        label="操作" 
        width="280" 
        fixed="right"
      >
        <template #default="scope">
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.SYS.ROLE.EDIT)"
            size="small" 
          ...
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.SYS.ROLE.ASSIGN_PERMISSION)"
            size="small" 
            type="primary" 
          ...
          <el-button
            v-if="hasActionPermission(PERMISSIONS.SYS.ROLE.DELETE) && !isBuiltinRole(scope.row.roleCode)"
            size="small"
            type="danger"
        ...
        >
          <template #default="{ data }">
            <div class="permission-tree-node">
              ...
              <span
                v-if="data.permissionPath"
                class="permission-path"
              >{{ data.permissionPath }}</span>
            </div>
          </template>
        </el-tree>
      </div>
