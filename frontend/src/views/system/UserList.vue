    ...
    <el-card v-else>
      <template #header>
        <div class="card-header">
          ...
          <el-button 
            v-if="hasActionPermission(PERMISSIONS.SYS.USER.CREATE)"
            type="primary" 
            @click="handleAdd"
          >
      ...
      >
        ...
        >
          <template #default="{ row }">
            <el-tag 
              v-if="!hasActionPermission(PERMISSIONS.SYS.USER.EDIT)"
        ...
        <el-table-column 
          v-if="hasActionPermission(PERMISSIONS.SYS.USER.EDIT) || hasActionPermission(PERMISSIONS.SYS.USER.DELETE) || hasActionPermission(PERMISSIONS.SYS.USER.RESET_PASSWORD)"
          label="操作" 
          width="220" 
          fixed="right"
        >
          <template #default="{ row }">
            <el-button-group>
              ...
              <el-button 
                v-if="hasActionPermission(PERMISSIONS.SYS.USER.RESET_PASSWORD)"
                type="success" 
                size="small" 
              ...
              <el-dropdown 
                v-if="hasActionPermission(PERMISSIONS.SYS.USER.DELETE) || hasActionPermission(PERMISSIONS.SYS.USER.EDIT)"
                trigger="click" 
              ...
              >
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item 
                      v-if="hasActionPermission(PERMISSIONS.SYS.USER.DELETE)"
                      divided 
                      command="delete"
                    >
