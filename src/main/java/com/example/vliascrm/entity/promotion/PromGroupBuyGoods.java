...
@Data
@Entity
@Table(name = "prom_group_buy_goods")
@EntityListeners(AuditingEntityListener.class)
public class PromGroupBuyGoods {
     ...
     * 虚拟成团数
     */
    @Column(name = "virtual_group_num", columnDefinition = "int default 0")
    private Integer virtualGroupNum = 0;
